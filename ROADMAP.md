...
- **Mesh LLM / GPU over the mesh.** filament already provides the hard part: a
  secure, NAT-traversing, authenticated P2P transport plus device identity, which
  is exactly the substrate distributed inference needs.
